...
class Editinfo with Books {
  ...
  for (var i = 1; i < bookList.length; i++) {
    if (shelfNo == i) {
      ...
      bookList.elementAt(i).update("Name", (value) => stdin.readLineSync());
          break;
        case 2:
            stdout.write(" New Author Name: ");
      bookList.elementAt(i).update("Author", (value) => stdin.readLineSync());
          break;
        case 3:
            stdout.write(" Book Price: ");
      bookList.elementAt(i).update("Price", (value) => stdin.readLineSync());
          break;
        case 4:
